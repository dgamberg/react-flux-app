...
var lint = require('gulp-eslint'); // Link JS and JSX Files

var config = {
    port: 9005,
    devBaseUrl: 'http://localhost',
    paths: {
        html: './src/*.html', // match all html files
        js: './src/**/*.js',
        images: './src/images/*',
        css: [
...
gulp.task('open', ['connect'], function(){ // run open, but run connect first as dependency
